...
Open the [Groniz Console API Keys page](https://groniz.com/console/connectors/api-keys), create a new key, and copy the value immediately — it is only shown once.
