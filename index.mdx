...
sidebarTitle: "Home"
description: "Groniz CLI lets AI agents post to 32+ social networks. Install the skill in one command, then drive the CLI from Claude Code, Cline, Cursor, or OpenCode."
---
