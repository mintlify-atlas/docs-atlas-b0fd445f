---
title: "Groniz CLI Quickstart: Install, Authenticate, and Post"
...
<Steps>
  ...
  <Step title="Authenticate">
    ...
    <Tip>
      For CI pipelines or headless environments, use an API key instead of the device flow. See the [Authentication](/authentication) page for details.
    </Tip>
  </Step>
