---
title: "Install the Groniz CLI and agent skill"
sidebarTitle: "Installation"
description: "Install the Groniz CLI native binary on Linux or macOS and add the groniz/groniz-cli agent skill to Claude Code, Codex, Cline, Cursor, or OpenCode."
---
