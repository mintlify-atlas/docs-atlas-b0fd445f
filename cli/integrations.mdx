...
description: "Use groniz integrations list and settings to find connected channels, get integration IDs, and inspect per-platform required fields and character limits."
---
