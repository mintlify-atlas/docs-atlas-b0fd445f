---
title: "groniz auth: login, logout, and whoami CLI commands"
sidebarTitle: "Auth"
description: "Reference for auth login (OAuth2 device flow), auth logout (delete credentials), and whoami (return current user id, email, and name)."
---
