...
sidebarTitle: "posts"
description: "Full reference for groniz posts create (schedule or post now), list (filter by date), delete (by ID), missing (find release IDs), and connect (link to published content)."
---
...
<ParamField body="-c, --content" type="string" required>
...
<ParamField body="--post-id" type="string" required>
  The Groniz post ID to link.
</ParamField>

<ParamField body="--release-id" type="string" required>
