...
description: "Reference for groniz analytics platform (channel-level metrics with date range) and analytics post (post-level metrics). Covers which platforms report analytics and which do not."
---
